        ...
        <div class="flex items-center space-x-2 w-full">
            ...
            <div x-data="{ isOpen: false }" class="w-full">
                ...
                <ul role="menu" x-show="isOpen" @click.away="isOpen = false"
                    ...
                    <li role="menuitem"
                        class="cursor-pointer text-main-text dark:text-dark-main-text flex w-full text-sm items-center p-3 transition-all hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100">
                        All
                    </li>
                    <li role="menuitem"
                        class="cursor-pointer text-main-text dark:text-dark-main-text flex w-full text-sm items-center p-3 transition-all hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100">
