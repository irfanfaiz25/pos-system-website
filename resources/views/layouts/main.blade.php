...
<body class="bg-[#FAFAFA] dark:bg-[#1c1c1c] font-sans">
    ...
    <div class="relative">
        <div class="flex gap-6 pt-16">
            ...
            <div
                class="flex-1 p-4 text-xl bg-[#e8e8e8] dark:bg-[#1c1c1c] text-gray-900 dark:text-gray-50 font-semibold overflow-auto relative min-h-screen duration-500 -ml-5 lg:ml-16">
